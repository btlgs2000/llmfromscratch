...
class SingleHeadAttention(nn.Module):
    def __init__(self, input_dim, output_dim, qkv_bias):
        super().__init__()
    ...
    def forward(self, x):
        ...
        # queries, keys, values: (batch_size, seq_len, output_dim)
        ...
        # normalizza gli attention scores relativamente alla dimensione dell'input
        attention_scores = attention_scores / (input_dim ** 0.5)
...
class SingleHeadAttentionCompleted(nn.Module):
    def __init__(self, input_dim, output_dim, qkv_bias, max_seq_len, dropout):
        super().__init__()
